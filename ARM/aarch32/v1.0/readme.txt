...
_stacklist and _stacklist_index: _stacklist is a memory buffer that behaves as a "parallel stack". _stacklist_index holds the current index value of _stacklist.
